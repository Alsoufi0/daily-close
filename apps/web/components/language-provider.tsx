...
const phraseKeys: Record<string, string> = {
  ...
  "from $29 per store / month · 14 days free · cancel anytime": "home.price",
  ...
  "Supabase not configured — opening contact page.": "auth.demoFallback",
  ...
  "Billing is from $29 USD per store per month, charged in advance, after a 14-day free trial. You can cancel at any time from the Billing page. Refunds are at our discretion for partial months.": "legal.subscriptionBody",
  ...
  "from $29 per store, per month. Billed monthly. Cancel anytime.": "billing.tagline",
