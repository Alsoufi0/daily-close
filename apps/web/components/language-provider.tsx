...
const phraseKeys: Record<string, string> = {
  ...
  "$49.99 per store / month · 14 days free · cancel anytime": "home.price",
  ...
  "Billing is $49.99 USD per store per month, charged in advance, after a 14-day free trial. You can cancel at any time from the Billing page. Refunds are at our discretion for partial months.": "legal.subscriptionBody",
  ...
  "$49.99 per store, per month. Billed monthly. Cancel anytime.": "billing.tagline",
